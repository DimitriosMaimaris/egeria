...
public class GraphConstants {
    ...
    public static final String PROPERTY_NAME_DATATYPE                         = "dataType";
    public static final String PROPERTY_NAME_OWNER                            = "owner";
    public static final String PROPERTY_NAME_PORT_TYPE                        = "portType";
    ...
    public static final String PROPERTY_KEY_ENTITY_NAME                    = PROPERTY_KEY_PREFIX_ElEMENT + PROPERTY_NAME_DISPLAY_NAME;
    ...
    public static final String PROPERTY_KEY_PORT_TYPE                      = PROPERTY_KEY_PREFIX_ElEMENT + PROPERTY_NAME_PORT_TYPE;
