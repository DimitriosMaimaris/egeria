...
public enum  GraphConnectorAuditCode {


    CONNECTOR_INITIALIZING("GRAPH-CONNECTOR-0001",
    ...
    CONNECTOR_INITIALIZED("GRAPH-CONNECTOR-0002",
            OMRSAuditLogRecordSeverity.INFO,
            ...
            "No action is required.  This is part of the normal operation of the service."),
    CONNECTOR_SHUTDOWN("GRAPH-CONNECTOR-0003",
            OMRSAuditLogRecordSeverity.INFO,
            ...
            "No action is required.  This is part of the normal operation of the service."),
    CONNECTOR_SERVER_CONFIGURATION_ERROR("GRAPH-CONNECTOR-0004",
    ...
    CONNECTOR_SERVER_ADDRESS_ERROR("GRAPH-CONNECTOR-0005",
            OMRSAuditLogRecordSeverity.EXCEPTION,
            "The address of the cassandra cluster is not valid.",
            "The local server is unable to create a connector.",
            "Check if the address of the cassandra cluster is valid"),
    CONNECTOR_REGISTER_LISTENER_ERROR("GRAPH-CONNECTOR-0006",
            OMRSAuditLogRecordSeverity.EXCEPTION,
     ...
     */
    GraphConnectorAuditCode(String messageId, OMRSAuditLogRecordSeverity severity, String message,
